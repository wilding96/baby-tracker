...
const defaultContent: Record<EmotionMode, string> = {
  faded: `凌晨三点，她又醒了。\n\n我轻轻抱起她，在客厅来回踱步，哼着不成调的摇篮曲。她的小手攥着我的食指，紧紧的，像抓住了全世界。\n\n累是真的累，但每当她睡着后均匀的呼吸声传来，心里就涌上一股说不清的暖意。\n\n原来这就是当爸爸的感觉。`,
  neon: `餐桌上，长辈又在说奶粉太贵、尿不湿太费、当初他们怎么怎么过来的。\n\n我低着头扒饭，一句话也没说。妻子看了我一眼，我也没回应。\n\n空气像凝固的果冻，把每个人都封在自己的位置上。窗外的蝉鸣一声比一声大，震得太阳穴突突地跳。\n\n这个家很热闹，只是没有我的声音。`,
  fever: `奶粉钱、房贷、父母的期望、妻子的委屈……\n\n所有声音同时涌上来，挤在脑子里，像一大锅沸腾的粥，噗噗地往外冒。我坐在马桶上刷手机，这是唯一不用面对任何人的地方。\n\n门外的世界在等我出去。但我只想让这五分钟变成五小时。\n\n我不是不想扛，我只是想喘口气。`,
};
